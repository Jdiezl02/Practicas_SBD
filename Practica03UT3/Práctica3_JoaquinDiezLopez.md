...
#  Práctica 3
>La práctica 3 consiste en sacar la informacion de una pagina de cryptomonedas.
## Paso 1
...
Creamos el metodo extraer_datos_criptomonedas().
```
...
Extraemos los datos específicos de una fila de la tabla.
```
...
Convierte un valor monetario en texto a un número float y le quitamos el simbolo $.
```
...
Es el main el que ejecuta todo.
```
...
>Esto de poder sacar informacion de las paginas web es bastante interesante y util para algunas que no tengan api.
